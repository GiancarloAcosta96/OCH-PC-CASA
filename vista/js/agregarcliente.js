      ...
      success: function (data) {
        ...
        if (datos["estado"] === "1") {
          ...
          $("#tablaDatatablehistorial").load(
            "../capa_presentacion/tablaHistorial.php?ruc=" + nvoruc
          );
          $("#tablaDatatabletelefono").load(
            "../capa_presentacion/tablaTelefono.php?ruc=" + nvoruc
          );
          $("#tablaDatatableplanta").load(
            "../capa_presentacion/tablaplanta.php?ruc=" + nvoruc
          );
          $("#tablaDatatablewinback").load(
            "../capa_presentacion/tablawinback.php?ruc=" + nvoruc
          );
        }
      },
    });
...
function TraerDatosTabla(ruc) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("#tablaDatatableplanta").load(
        "../capa_presentacion/tablaplanta.php?ruc=" + ruc
      );
      $("#tablaDatatablewinback").load(
        "../capa_presentacion/tablawinback.php?ruc=" + ruc
      );
    },
  });
}
