...
<div  class="col-lg-12"  style="background-color: #00a65a;color: white; font-weight: bold;text-align: center ">FUNNEL GESTION MOVIL</div>
...
<div class="row"> <!--- div para elegir el tipo de respuesta-->
            ...
            <input type="hidden"   class="form-control input-sm" id="fechahoy" name="fechahoy" value="<?php date_default_timezone_set("America/Lima");
