...
if (
    $estado === 'OBSERVADO' || $estado === 'INSERTADO' || $estado === 'PENDIENTE' || $estado === 'EMITIDO' ||
    $estado === 'INSTALADO' || $estado === 'BOLSA'
) {
...
ORDER BY ncf.fecha_ingreso DESC";
 ...
 from nc_fija as ncf 
where  year(ncf.fecha_ingreso)<='$ano' and 
ncf.id_usuario='$idusu' and ncf.estado in ('OBSERVADO','INSERTADO','PENDIENTE','EMITIDO','INSTALADO','BOLSA') 
