...
if ($ncestado === 'PENDIENTE' || $ncestado === 'INSERTADO' || $ncestado === 'EMITIDO' || $ncestado === 'OBSERVADO' ||   $ncestado === 'INSTALADO' || $ncestado === 'BOLSA') {
...
ncf.estado in ('PENDIENTE','INSERTADO','EMITIDO','OBSERVADO','INSTALADO','BOLSA')  and ncf.zonal='$tienda'
...
SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.modalidad,
 ...
 from nc_fija as ncf left join usuario as u on u.id_usuario=ncf.id_usuario
where month(ncf.fecha_liquidacion)='$periodo' and year(ncf.fecha_liquidacion)='$ano' and ncf.estado=
'LIQUIDADO'   and ncf.zonal='$tienda'
