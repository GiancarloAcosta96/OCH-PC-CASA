...
$sqldatos = "SELECT ll.fecha,ll.ruc, ll.razon_social,r.descripcion, ll.telefono,ll.comentario,ll.id_llamada,ll.tipo_data,ll.gestion, d.origen
 from  llamada as ll inner join respuesta as r on ll.id_respuesta=r.id_respuesta inner join datos d on ll.ruc = d.ruc
