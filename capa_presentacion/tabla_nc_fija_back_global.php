...
if ($tienda === 'TODO') {
    ...
    if (
        $ncestado === 'OBSERVADO' || $ncestado === 'PENDIENTE' || $ncestado === 'INSERTADO' || $ncestado === 'EMITIDO' ||
        $ncestado === 'INSTALADO' || $ncestado === 'BOLSA'
    ) {


        $sqlncFija = " SELECT ncf.id_cargo,ncf.fecha_ingreso, ncf.ruc,ncf.razon_social,ncf.peticion,
 ncf.subtipo, ncf.descripcion , ncf.direccion, ncf.estado,ncf.contrata,ncf.ejecutivo_telefonica,car.propietario, usu.personal,ncf.nodo
...
ncf.estado in ('OBSERVADO','INSERTADO','PENDIENTE','EMITIDO','INSTALADO','BOLSA') and ncf.validacion='PROCEDE'  
...
";
    ...
    if (
        $ncestado === 'OBSERVADO' || $ncestado === 'INSERTADO' || $ncestado === 'PENDIENTE' ||  $ncestado === 'EMITIDO' ||
        $ncestado === 'INSTALADO' || $ncestado === 'BOLSA'
    ) {
...
ORDER BY ncf.fecha_ingreso DESC";
 ...
 from nc_fija as ncf left join cartera as car on car.id_cartera=ncf.id_cartera left join usuario as usu on usu.id_usuario=ncf.id_usuario
where  year(ncf.fecha_validacion)<='$ano' and 
ncf.estado in ('OBSERVADO','INSERTADO','PENDIENTE','EMITIDO','INSTALADO','BOLSA') and ncf.validacion='PROCEDE'  and ncf.zonal='$tienda'
